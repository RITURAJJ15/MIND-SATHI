...
export const CaregiverPortalPage: React.FC = () => {
  ...
  const [connectMethod, setConnectMethod] = useState<'code' | 'credentials'>('code');
        ...
        <div className="bg-white p-8 rounded-3xl shadow-elder border border-emerald-200">
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-gray-600 mt-1 max-w-md mx-auto leading-relaxed">
              Connect to your patient securely using their unique Connection Code (shown on their home screen), verified email, or password credentials.
            </p>
          </div>

          {/* Connection Method Tabs */}
          <div className="flex bg-gray-100 p-1 rounded-2xl mb-6 max-w-md mx-auto">
            <button
              type="button"
              onClick={() => { setConnectMethod('code'); setLinkError(''); }}
            ...
            >
              Connection Code / Email
            </button>
            <button
              type="button"
              onClick={() => { setConnectMethod('credentials'); setLinkError(''); }}
              className={`flex-1 py-2 text-xs font-bold rounded-xl transition-all cursor-pointer ${
            ...
            <form onSubmit={handleConnectByCodeOrEmail} className="space-y-4 mb-6 text-left">
              <div>
                <label className="block text-xs font-bold text-gray-700 mb-1">
                  Patient's Connection Code or Email
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="e.g. MS-1A2B3C or patient@gmail.com"
                ...
                <p className="text-[11px] text-gray-500 mt-1.5">
                  💡 Patients can find their 8-character code (e.g. <strong>MS-XXXXXX</strong>) on their MIND SATHI Home Screen banner.
                </p>
              </div>
              ...
              >
                <div>
                  ...
                  <p className="text-[11px] text-gray-500 mt-1">
                    💡 Found on the patient's MIND SATHI Home Screen banner (e.g. <strong>MS-XXXXXX</strong>).
                  </p>
                </div>

/**
 * api/bhashini/bhashiniClient.ts
 * ─────────────────────────────────────────────────────────────────────────────
 * Self-contained Bhashini ULCA / Dhruva serverless client for Vercel.
 * Fully contained inside api/ to ensure 100% Vercel Lambda bundling compatibility
 * without cross-directory module resolution errors.
 */
